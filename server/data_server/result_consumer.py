...
def _handle_result(msg: dict):
    ...
    if msg["result"] == "success":
        ...
        for garment in msg.get("garments", []):
            _insert_garment(info["account_id"], info["user_id"], job_id, info["job_item_id"], garment, settings)
    else:
...
def _insert_garment(account_id: str, user_id: str, job_id: str, job_item_id: str, garment: dict, settings):
    ...
    if duplicate_of:
        ...
        return  # spec: data-server skips creating a new record for a confirmed duplicate
