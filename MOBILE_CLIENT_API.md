...
| Môi trường | Base URL |
|---|---|
| Test (máy vast.ai hiện tại) | `http://218.49.89.120:41126` |
...
> Port `41126` là port public mà vast.ai map cho container port `10100`. Nếu instance
...
```
GET http://218.49.89.120:41126/v1/wardrobe/items?token=<EDGE_TOKEN>
  ...
  "items": [
    {
      ...
      "uploadUrl": "http://218.49.89.120:41077/wardrobe-raw/raw/...?X-Amz-Algorithm=...",
...
```http
PUT http://218.49.89.120:41077/wardrobe-raw/raw/...?X-Amz-Algorithm=...
Content-Type: image/jpeg
Cookie: C.51266227_auth_token=<EDGE_TOKEN>
...
3. **Edge token ở môi trường Test phải đi bằng Cookie, không phải query param** — thêm
   ...
   trên instance hiện tại là `C.51266227_auth_token`. Production không cần cookie này.
...
```jsonc
{
  "items": [
    {
      "imageUrl": "http://218.49.89.120:41077/wardrobe-items/items/...?X-Amz-Algorithm=...",
      "jobId": "e1f0b194-2110-4278-8462-1d6e5e9bee48",
      "tags": {
        "type": "shirts",
        "category": "clothing",
...
```bash
BASE=http://218.49.89.120:41126
EDGE=<EDGE_TOKEN>
APP=$(grep TEST_BEARER_TOKEN ${WORKSPACE:-/workspace}/.env | cut -d= -f2)
COOKIE="C.51266227_auth_token=$EDGE"
